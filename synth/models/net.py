...
class ResNet(BasicModule):
    def __init__(self, name, block, layers, input_channel, output_channel, pretrained=False, dilation_state=False, use_pool=False):
        ...
        if pretrained:
            ...
            pretrained_model = 'models/resnet34-333f7ec4.pth'
